...
|------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **NAME**         | Should only contain letters, numbers, spaces, and these characters: `- / ' , . ( ) [ ] { } _`.<br>Must be no more than 50 characters long, contain at least one letter or number, and should not be blank.                                                                                                                                                      |
| **EMAIL**         | Should be of the format `local-part@domain`.<br>The `local-part` should only contain alphanumeric characters and these special characters: `+`, `_`, `.`, `-`. It cannot start or end with a special character.<br>The `domain` consist of labels separated by periods. Each label must start and end with alphanumeric characters and consist of alphanumeric characters separated by hyphens. The last label must be at least 2 characters long. |
| **PHONE_NUMBER** | Should only contain numbers, and should be at least 3 digits long.                                                                                                                                                                                                                                                                                             |
| **ADDRESS**      | Can take any value, but should not be blank or a single dash `-`.                                                                                                                                                                                                                                                                                               |
| **TELEGRAM_HANDLE** | Should be 5-32 characters long.<br>Can only contain alphanumeric characters or underscores.<br>Can optionally start with `@`.                                                                                                                                                                                                                                   |
| **TAG**          | Should be alphanumeric and at most 20 characters long.                                                                                                                                                                                                                                                                                                         |
| **COURSE_CODE**  | Should be alphanumeric.                                                                                                                                                                                                                                                                                                                                         |
| **TUTORIAL_GROUP** | Should be alphanumeric.                                                                                                                                                                                                                                                                                                                                         |
| **WEEK**         | Must be a number from 1 to 13 (inclusive).                                                                                                                                                                                                                                                                                                                      |
